...
| **2** | [`02-phase-2-tier-1.md`](./02-phase-2-tier-1.md) | Credibility leaks currently public | Jul 29 | ✅ **LIVE** |
| **3** | [`03-phase-3-tier-2.md`](./03-phase-3-tier-2.md) | Structural, needs build time — mobile CTA bar, analytics, RSVP button, VIRTUAL display line, discipline tags, sponsor move | Jul 29 | 🟨 **5/7 LIVE** — GA4 config + Luma test need a human |
